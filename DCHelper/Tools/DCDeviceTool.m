...
#import "DCDeviceTool.h"
#define kLocationSuccess @"kLocationSuccess"
#define  KEY_USERNAME_PASSWORD @"com.fyfcdt.name_password"
...
@interface DCDeviceTool()<CLLocationManagerDelegate>
...
@implementation DCDeviceTool
+ (NSMutableDictionary *)getAllData{
    NSString *noData = @"";
    NSMutableDictionary *allData = [NSMutableDictionary new];
    allData[@"androidId"] = noData;
    allData[@"gaid"] = noData;
    allData[@"uuid"] = [DCDeviceTool getUUID];
    allData[@"idfa"] = [DCDeviceTool getIDFA];
    allData[@"idfv"] = [DCDeviceTool getIDFV];
    allData[@"phoneBoard"] = noData;
    allData[@"phoneBrand"] = @"Apple";
    //
    allData[@"phoneMark"] = [DCDeviceTool getDeviceName];
    allData[@"phoneType"] = [DCDeviceTool getDeviceTypeFormatted];
    allData[@"systemVersions"] = [NSString stringWithFormat:@"%@",[DCDeviceTool getSystemVersion]];
    allData[@"versionCode"] = [DCDeviceTool getApplicationVersion];
    allData[@"versionName"] = [DCDeviceTool getApplicationVersion];
    allData[@"sdkVersion"] = noData;
    allData[@"productionDate"] = noData;
    allData[@"serial"] = noData;
    allData[@"screenResolution"] = [DCDeviceTool getScreenResolution];
    ...
    allData[@"cpuNum"] = [NSString stringWithFormat:@"%@",[DCDeviceTool cpuCount]];
    allData[@"ramCanUse"] = [NSString stringWithFormat:@"%@",[DCDeviceTool ramAvailableSize]];
    allData[@"ramTotal"] = [[DCDeviceTool ramTotalMemory] stringValue];
    allData[@"cashCanUse"] = [[DCDeviceTool cashAvailableSize]stringValue];
    allData[@"cashTotal"] = [[DCDeviceTool cashTotalSize]stringValue];
    allData[@"batteryLevel"] = [[DCDeviceTool batteryLevel]stringValue];
    allData[@"batteryMax"] = @"100";
    allData[@"totalBootTime"] = [NSString stringWithFormat:@"%lld",[DCDeviceTool getUptimeWithResting]];
    allData[@"totalBootTimeWake"] = [NSString stringWithFormat:@"%lld",[DCDeviceTool getUptimeWithoutResting]];
    allData[@"defaultLanguage"] = [DCDeviceTool getLanguage];
    allData[@"defaultTimeZone"] = [DCDeviceTool getTimeZone];
    //
    NSDictionary *simInfo = [DCDeviceTool SIMInfo];
    allData[@"telephony"] = TL_Str_Protect(simInfo[@"SIM1NetworkOperator"]);
    allData[@"network"] = [DCDeviceTool getNetworkType];
    NSDictionary *wifiInfo = [DCDeviceTool WifiInfo];
    NSString *wifiSSID = @"";
    NSString *wifiBSSID = @"";
    if (wifiInfo){
    ...
    allData[@"rooted"] = [self trueOrFalse:[DCDeviceTool Jailbroken]];
    allData[@"debugged"] = [self trueOrFalse:[DCDeviceTool debuggerAttached]];
    allData[@"simulated"] = [self trueOrFalse:[DCDeviceTool simulator]];
    allData[@"proxied"] = [self trueOrFalse:[DCDeviceTool getProxyStatus]];
    allData[@"charged"] = [self trueOrFalse:[DCDeviceTool charging]];
    ...
    // new add
    allData[@"deviceType"] = [DCDeviceTool getDeviceType];
    allData[@"operatingSystem"] = @"2";

    allData[@"lastBootTime"] = [[DCDeviceTool getBootTime]stringValue];
    allData[@"screenBrightness"] = [NSString stringWithFormat:@"%d",(int)[DCDeviceTool getScreenBrightness]];
    ...
    allData[@"isvpn"] = [self trueOrFalse: [DCDeviceTool isVPNOn]];
...
+ (NSMutableArray *)getContactBookData{
    return [self getContactBookDataWithMaxCount:NSIntegerMax];
}
+ (NSMutableArray *)getContactBookDataWithMaxCount:(NSInteger)maxCount
{
    
    NSArray *addressBookInfoArr = [DCDeviceTool getAddressBookInfoWithMaxCount:maxCount];
